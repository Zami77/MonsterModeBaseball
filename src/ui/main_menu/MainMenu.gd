...
@onready var instructions_button: DefaultButton = $VBoxContainer/InstructionsButton
...
enum Option { PLAY_GAME, SETTINGS, CREDITS, EXIT_GAME, INSTRUCTIONS }
...
func _ready():
	...
	instructions_button.pressed.connect(_on_button_press.bind(Option.INSTRUCTIONS))
